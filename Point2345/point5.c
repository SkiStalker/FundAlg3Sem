...
int main() {
    printf("Examples of using overfprintf:\n\n");

    overfprintf(stdout, "Roman numeral: %Ro\n", 1987);
    overfprintf(stdout, "Zeckendorf representation: %Zr\n", 10);
    overfprintf(stdout, "Representation in base 16 (lowercase): %Cv\n", -255, 16);
    overfprintf(stdout, "Representation in base 36 (uppercase): %CV\n", 42, 36);
    overfprintf(stdout, "Representation in default base: %Cv\n", 42, 50); // Base 50 is out of range
    overfprintf(stdout, "String to decimal number (base 16): %to\n", "1a", 16);
    overfprintf(stdout, "String to decimal number (base 36): %TO\n", "z", 36);
    overfprintf(stdout, "Memory dump (signed): %mi\n", -13);
    overfprintf(stdout, "Memory dump (unsigned): %mu\n", 255);
    overfprintf(stdout, "Memory dump (float): %mf\n", 3.14f);
    overfprintf(stdout, "Memory dump (double): %md\n", 3.14159);

    printf("\n");
    printf("Examples of using oversprintf:\n\n");

    char buffer[1000];

    oversprintf(buffer, "Roman numeral: %Ro\n", 1987);
    printf("%s", buffer);

    oversprintf(buffer, "Zeckendorf representation: %Zr\n", 10);
    printf("%s", buffer);

    oversprintf(buffer, "Representation in base 16 (lowercase): %Cv\n", -255, 16);
    printf("%s", buffer);

    oversprintf(buffer, "Representation in base 36 (uppercase): %CV\n", 42, 36);
    printf("%s", buffer);

    oversprintf(buffer, "Representation in default base: %Cv\n", 42, 50);
    printf("%s", buffer);

    oversprintf(buffer, "String to decimal number (base 16): %to\n", "1a", 16);
    printf("%s", buffer);

    oversprintf(buffer, "String to decimal number (base 36): %TO\n", "z", 36);
    printf("%s", buffer);

    oversprintf(buffer, "Memory dump (signed): %mi\n", -255);
    printf("%s", buffer);

    oversprintf(buffer, "Memory dump (unsigned): %mu\n", 255);
    printf("%s", buffer);
